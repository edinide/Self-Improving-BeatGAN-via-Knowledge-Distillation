...
class AD_MODEL(object):
    ...
    def load(self):
        ...
        save_dir = os.path.join(self.outf, self.model, self.dataset, "model")
        #self.G.load_state_dict(torch.load(os.path.join("model", self.model+"_folder_"+str(self.opt.folder) + '_G.pkl')))
        #self.D.load_state_dict(torch.load(os.path.join("model", self.model+"_folder_"+str(self.opt.folder) + '_D.pkl')))
    ...
    def copy(self):
        #load teacher model 
        save_dir = os.path.join(self.outf, "beatgan", self.dataset, "model")
        self.G.load_state_dict(torch.load(os.path.join(save_dir, "beatgan"+"_folder_"+str(self.opt.folder) + '_G.pkl')))
        self.D.load_state_dict(torch.load(os.path.join(save_dir, "beatgan"+"_folder_"+str(self.opt.folder) + '_D.pkl')))

        #save teacher model to student folder path (==def save_weight_GD)
        save_dir = os.path.join(self.outf, self.model, self.dataset, "model")
