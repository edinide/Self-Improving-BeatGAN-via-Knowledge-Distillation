...
class Options():
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--model', type=str, default='beatgan_s', help='choose model')
        self.parser.add_argument('--outf', default='./output', help='output folder')
        self.parser.add_argument('--temperature', default=4, type=float) ##

        ##
        #distill ##
        self.parser.add_argument('--width', default=2, type=int)
        self.parser.add_argument('--distill', default='att', type=str)
        self.parser.add_argument('--alpha', default=1.0, type=float)
        self.parser.add_argument('--beta', default=0.0, type=float)
